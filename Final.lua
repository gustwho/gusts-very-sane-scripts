...
if not game:GetService("RunService"):IsStudio()then if game:GetService("CoreGui"):FindFirstChild("IsGvSsRunning") then error("")else Instance.new("BoolValue",game:GetService("CoreGui")).Name="IsGvSsRunning" end end
...
local ModuleCustomScriptNetworkOwnerMover = (function()
function module(GS)
...
ModuleCustomScriptNetworkOwnerMover(GS)
